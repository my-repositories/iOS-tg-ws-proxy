...
# Вытаскиваем аргументы для ios.py отдельно
...
# МАНКИ-ПАТЧИНГ: Подменяем sys.argv для внутренних конфигураторов проекта,
# чтобы они считали, что всё запущено штатно через CLI
sys.argv = [sys.argv[0]]
...
# Инициализируем глобальный конфиг переданными аргументами
